...
All notable changes to **Pax Code** extension will be documented in this file.
...
This is the first stable release of Pax Code extension!
...
- ⌨️ **Hotkeys Panel** - Activity bar panel showing keyboard shortcuts reference
  - Font / Zoom shortcuts
  - Editor Tabs & Groups shortcuts
  - Explorer / Sidebar shortcuts
  - Terminal shortcuts
...
- macOS-style keyboard icons for better readability:
  ...
  - `⇥` Tab
  - `⌫` Backspace
- Auto-load hotkeys when VS Code starts
- Semantic highlighting support for both themes
